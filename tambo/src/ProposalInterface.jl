...
function make_sector(medium::Int64, start::Float64, stop::Float64)
...
function make_medium(medium::Vector{Tuple{Int64,Float64}})
...
function make_propagator(particle::Particle, medium::Vector{Tuple{Int64,Float64}})
...
function propagate_mcp(particle::Particle, medium::Vector{Tuple{Int64,Float64}}, mcp_energies::Vector{Float64},)
...
medium = [(1,0.5e5),(0,0.5e5),(1,0.928e5),(0,0.01289e5),(0,0.1e5)]

particle = particle = Particle(1.0,1.0)

mcp_energies = [1e1,1e2, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10]
