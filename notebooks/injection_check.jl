...
begin
	fname1 = "/Users/jlazar/research/TAMBO-MC/100000_upgoing_injection_check.h5"
	fid1 = h5open(fname1, "r");
end
...
begin
	xx = fid1["interaction_vertex_x"][]
	yy = fid1["interaction_vertex_y"][]
	zz = fid1["interaction_vertex_z"][]
	...
	plot!(plt, xlim=(-20000, 20000), ylim=(-2.5e4, 5000))
    ...
    annotate!(plt, -1.7e4, -2.25e4, text(string_xlxh, :left, 9, "sans_serif"))
end
